...
const subCss = css({ textStyle: { base: "ui", md: "body" }, color: "ink2", mt: "6px" });
...
const pillRaw = css.raw({ appearance: "none", display: "inline-flex", alignItems: "center", justifyContent: "center", border: "none", cursor: "pointer", borderRadius: "999px", bg: "rgba(0,0,0,0.05)", color: "#000", fontWeight: 600, whiteSpace: "nowrap", transition: "background-color .25s", _hover: { bg: "rgba(0,0,0,0.1)" }, _disabled: { opacity: 0.5, cursor: "default", pointerEvents: "none" } });
const markAllCss = css(pillRaw, { h: "40px", px: "16px", textStyle: "ui", gap: "8px", "& svg": { ml: "-4px" } });
const tabsRowCss = css({ display: "flex", gap: "8px", flexWrap: "wrap" });
const tabRaw = css.raw({ appearance: "none", display: "inline-flex", alignItems: "center", gap: "7px", h: "36px", px: "16px", borderRadius: "999px", border: "none", cursor: "pointer", textStyle: "ui", fontWeight: 500 });
...
const tabCountRaw = css.raw({ fontVariantNumeric: "tabular-nums", textStyle: "micro", fontWeight: 600 });
...
const emptyTitleCss = css({ textStyle: "title", fontWeight: 600 });
const emptyBodyCss = css({ textStyle: "body", color: "ink2", mt: "6px" });
...
const groupLabelCss = css({ textStyle: "eyebrow", fontWeight: 600, color: "ink3", px: "2px" });
const loadMoreWrapCss = css({ display: "flex", justifyContent: "center", pt: "4px" });
const loadMoreCss = css(pillRaw, { h: "42px", px: "28px", textStyle: "ui" });
...
const cardTitleRaw = css.raw({ textStyle: "body", color: "ink" });
const cardTitleUnreadCss = css(cardTitleRaw, { fontWeight: 600 });
const cardTitleReadCss = css(cardTitleRaw, { fontWeight: 500 });
const cardBodyCss = css({ textStyle: "ui", color: "ink2", lineClamp: 2 });
const cardMetaCss = css({ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" });
const cardTimeCss = css({ textStyle: "meta", color: "ink3", fontWeight: 500, whiteSpace: "nowrap" });
const ctaCss = css(pillRaw, { h: { base: "36px", sm: "38px" }, px: "14px", textStyle: "ui", flex: { base: "1", sm: "none" }, gap: "8px", "& svg": { mr: "-4px" } });
