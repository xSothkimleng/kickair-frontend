...
import { Box, Container, Typography, Avatar, Skeleton, Button } from "@mui/material";
import { ChevronRight, RequestQuoteOutlined } from "@mui/icons-material";
import { tokens } from "@/theme";
import { CustomOrder } from "@/types/customOrder";
import { Money, coCard, coLabel, Chip, initials } from "@/components/customOrders/kit";
...
export default function ClientCustomOrdersPage() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: tokens.canvas }}>
      <Container disableGutters sx={{ maxWidth: "820px !important", px: { xs: 2, sm: 4 }, py: { xs: 3, sm: 5 } }}>
        <Box sx={{ mb: { xs: 2.5, sm: 3.5 } }}>
          <Typography sx={{ ...coLabel, fontFamily: tokens.mono, color: tokens.accent }}>Client</Typography>
          <Typography sx={{ fontSize: 30, fontWeight: 600, letterSpacing: "-0.02em", mt: 0.5 }}>Custom orders</Typography>
