            ...
            >
              <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                ...
                <Box>
                  ...
                  <Box component="ul" sx={{ listStyle: "none", py: 0, m: 0 }}>
                    <Box component="li" sx={{ display: "flex", alignItems: "flex-start", gap: 1, mb: 1 }}>
                      ...
                      <Typography sx={{ fontSize: "13px", color: "rgba(0, 0, 0, 0.7)" }}>Reviews locked until payment is completed</Typography>
                    </Box>
                    <Box component="li" sx={{ display: "flex", alignItems: "flex-start", gap: 1 }}>
                      <CheckCircle sx={{ fontSize: 16, color: "#0071e3", flexShrink: 0, mt: 0.25 }} />
                      <Typography sx={{ fontSize: "13px", color: "rgba(0, 0, 0, 0.7)" }}>Both freelancers and clients review each other</Typography>
                    </Box>
                  </Box>
                </Box>
              </Box>
              ...
              <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                ...
                <Box>
                  ...
                  <Box component="ul" sx={{ listStyle: "none", p: 0, m: 0 }}>
                    ...
                    <Box component="li" sx={{ display: "flex", alignItems: "flex-start", gap: 1 }}>
                      <CheckCircle sx={{ fontSize: 16, color: "#16a34a", flexShrink: 0, mt: 0.25 }} />
                      <Typography sx={{ fontSize: "13px", color: "rgba(0, 0, 0, 0.7)" }}>Fair to hardworking freelancers</Typography>
                    </Box>
                  </Box>
                </Box>
              </Box>
          ...
          <Grid container spacing={2} sx={{ maxWidth: "768px", mx: "auto" }}>
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              ...
              >
                ...
                <Typography sx={{ fontSize: "12px", color: "rgba(0, 0, 0, 0.6)" }}>Private • Only visible to freelancers</Typography>
              </Box>
            </Grid>
          </Grid>
        </Box>
