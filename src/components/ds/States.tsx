...
const titleCss = css({ textStyle: "body", fontWeight: 600, color: "heading" });
const bodyCss = css({ textStyle: "ui", color: "muted", maxW: "380px" });
...
export function Loading({ label = "Loading…", tall, className }: { label?: string; tall?: boolean; className?: string }) {
  return (
    <div className={cx(css({ display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", color: "muted", textStyle: "ui" }), tall ? css({ py: "96px" }) : css({ py: "40px" }), className)}>
