...
/** Accordion on Ark (keyboard nav, aria). Raw parts: AccordionPrimitive. */
...
const triggerCss = css({
  ...
  border: "none", bg: "transparent", textStyle: "body", fontWeight: 600, color: "heading", textAlign: "left", cursor: "pointer",
...
const contentCss = css({ pb: "14px", textStyle: "body", color: "body", _focus: { outline: "none" } });
